...
//Scalar Processing::m_upper = { 20, 280, 50 };                  
//Scalar Processing::m_lower = { 40, 255, 255 };

// Fluorescent lighting - working but not perfect
Scalar Processing::m_lower = { 20, 190, 20 };
Scalar Processing::m_upper  = { 30, 255, 255 }; 

Scalar Processing::m_contourColor = { 124, 252, 0 };           
Scalar Processing::m_centerColor = { 255, 105, 180 }; 
...
void Processing::FindBiggestContour()
{
    if (m_contours.size() == 0)
    { 
        return;
...
void Processing::CalcCubeHeight()
{
    if (m_contours.size() == 0)
    { 
        return;
...
double Processing::CalcOutputValues()
{
    if (m_contours.size() == 0)
    { 
        return 0.0;
...
void Processing::PrintDebugValues()
{
